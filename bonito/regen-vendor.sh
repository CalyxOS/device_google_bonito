...
VENDOR_SKIP_FILES=(
    ...
    "apex/com.android.vibrator.drv2624.apex"
    "bin/["
    "bin/acpi"
    "bin/applypatch"
    "bin/awk"
    ...
    "bin/hw/android.hardware.dumpstate@1.1-service.bonito"
    "bin/hw/android.hardware.gnss@1.1-service-qti"
    "bin/hw/android.hardware.graphics.composer@2.2-service"
    "bin/hw/android.hardware.health.storage@1.0-service"
    "bin/hw/android.hardware.health@2.0-service.bonito"
    ...
    "bin/hw/android.hardware.usb@1.3-service.bonito"
    ...
    "etc/acdbdata/OEM/sdm670-intcodec-b4-snd-card/Bluetooth_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4-snd-card/General_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4-snd-card/Global_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4-snd-card/Handset_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4-snd-card/Hdmi_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4-snd-card/Headset_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4-snd-card/Speaker_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4dev-snd-card/Bluetooth_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4dev-snd-card/General_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4dev-snd-card/Global_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4dev-snd-card/Handset_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4dev-snd-card/Hdmi_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4dev-snd-card/Headset_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-b4dev-snd-card/Speaker_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4-snd-card/Bluetooth_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4-snd-card/General_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4-snd-card/Global_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4-snd-card/Handset_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4-snd-card/Hdmi_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4-snd-card/Headset_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4-snd-card/Speaker_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4dev-snd-card/Bluetooth_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4dev-snd-card/General_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4dev-snd-card/Global_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4dev-snd-card/Handset_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4dev-snd-card/Hdmi_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4dev-snd-card/Headset_cal.acdb"
    "etc/acdbdata/OEM/sdm670-intcodec-s4dev-snd-card/Speaker_cal.acdb"
    "etc/acdbdata/adsp_avs_config.acdb"
    "etc/audio_effects.xml"
    "etc/audio_platform_info_intcodec_b4.xml"
    "etc/audio_platform_info_intcodec_b4dev.xml"
    "etc/audio_platform_info_intcodec_s4.xml"
    "etc/audio_platform_info_intcodec_s4dev.xml"
    ...
    "etc/init/android.hardware.dumpstate@1.1-service.bonito.rc"
    ...
    "etc/init/android.hardware.health@2.0-service.bonito.rc"
    ...
    "etc/init/android.hardware.usb@1.3-service.bonito.rc"
    ...
    "etc/init/com.android.vibrator.drv2624.enable.rc"
    "etc/init/hostapd.android.rc"
    "etc/init/hw/init.bonito.rc"
    "etc/init/hw/init.sargo.rc"
    "etc/init/hw/init.sdm670.diag.rc"
    "etc/init/hw/init.sdm670.logging.rc"
    "etc/init/hw/init.sdm670.mpssrfs.rc"
    "etc/init/hw/init.sdm670.power.rc"
    "etc/init/hw/init.sdm670.rc"
    "etc/init/hw/init.sdm670.usb.rc"
    "etc/init/pixel-mm-legacy.rc"
    "etc/init/pixel-thermal-symlinks.rc"
    "etc/init/pixelstats-vendor.bonito.rc"
    "etc/init/vendor_flash_recovery.rc"
    "etc/init/vndservicemanager.rc"
    "etc/libese-nxp.conf"
    "etc/libnfc-nxp-G020A.conf"
    "etc/libnfc-nxp-G020B.conf"
    "etc/libnfc-nxp-G020C.conf"
    "etc/libnfc-nxp-G020D.conf"
    "etc/libnfc-nxp.conf"
    "etc/lowi.conf"
    ...
    "etc/mixer_paths_intcodec_b4.xml"
    "etc/mixer_paths_intcodec_b4dev.xml"
    "etc/mixer_paths_intcodec_s4.xml"
    "etc/mixer_paths_intcodec_s4dev.xml"
    "etc/mkshrc"
    "etc/passwd"
    ...
    "etc/thermal-engine-bonito.conf"
    ...
    "etc/vintf/manifest/android.hardware.usb.gadget@1.1-service.bonito.xml"
    "etc/vintf/manifest/android.hardware.usb@1.3-service.bonito.xml"
    ...
    "etc/vintf/manifest/com.android.vibrator.drv2624.xml"
    ...
    "firmware/crus_sp_config_b4_rx.bin"
    "firmware/crus_sp_config_b4_tx.bin"
    "firmware/crus_sp_config_s4_rx.bin"
    "firmware/crus_sp_config_s4_tx.bin"
    ...
    "lib/modules/synaptics_dsx_core.ko"
    "lib/modules/synaptics_dsx_fw_update.ko"
    "lib/modules/synaptics_dsx_rmi_dev.ko"
    "lib/modules/synaptics_dsx_test_reporting.ko"
    "lib/modules/wlan.ko"
    ...
    "odm/etc/group"
    "odm/etc/passwd"
    "odm/etc/permissions/sku_G020A/android.hardware.nfc.uicc.xml"
    "odm/etc/permissions/sku_G020B/android.hardware.nfc.uicc.xml"
    "odm/etc/permissions/sku_G020C/android.hardware.nfc.uicc.xml"
    "odm/etc/permissions/sku_G020D/android.hardware.nfc.ese.xml"
    "odm/etc/permissions/sku_G020D/android.hardware.se.omapi.ese.xml"
    "odm/etc/permissions/sku_G020D/com.google.hardware.pixel.japan.xml"
    "odm/etc/permissions/sku_G020E/android.hardware.nfc.uicc.xml"
    "odm/etc/permissions/sku_G020F/android.hardware.nfc.uicc.xml"
    "odm/etc/permissions/sku_G020G/android.hardware.nfc.uicc.xml"
    "odm/etc/permissions/sku_G020H/android.hardware.nfc.ese.xml"
    "odm/etc/permissions/sku_G020H/com.google.hardware.pixel.japan.xml"
    "odm/etc/vintf/manifest_G020A.xml"
    "odm/etc/vintf/manifest_G020B.xml"
    "odm/etc/vintf/manifest_G020C.xml"
    "odm/etc/vintf/manifest_G020D.xml"
    "odm/etc/vintf/manifest_G020E.xml"
    "odm/etc/vintf/manifest_G020F.xml"
    "odm/etc/vintf/manifest_G020G.xml"
    "odm/etc/vintf/manifest_G020H.xml"
    ...
    "lib/hw/gralloc.sdm710.so"
    "lib/hw/hwcomposer.sdm710.so"
    "lib/hw/memtrack.sdm710.so"
    ...
    "lib64/hw/gralloc.sdm710.so"
    "lib64/hw/hwcomposer.sdm710.so"
    "lib64/hw/memtrack.sdm710.so"
