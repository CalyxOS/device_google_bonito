...
VENDOR_SKIP_FILES=(
    ...
    "etc/libese-nxp.conf"
    "etc/libnfc-nxp-G020E.conf"
    "etc/libnfc-nxp-G020F.conf"
    "etc/libnfc-nxp-G020G.conf"
    "etc/libnfc-nxp-G020H.conf"
    "etc/libnfc-nxp.conf"
    "etc/lowi.conf"
